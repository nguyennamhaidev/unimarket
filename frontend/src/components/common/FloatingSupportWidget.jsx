          ...
          {activeTab === 'chat' && (
            <div className="p-4 flex-1 overflow-y-auto space-y-3.5 custom-scrollbar text-xs">
              ...
              <div className="pt-2 border-t border-slate-100 space-y-1.5">
                <div className="text-[11px] font-bold text-slate-600">Kênh hỗ trợ khẩn cấp:</div>
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    <span className="w-3.5 h-3.5 bg-blue-600 text-white rounded text-[9px] font-black flex items-center justify-center">Z</span>
                    <span>Zalo Hỗ Trợ</span>
                  </a>
                  <a
                    href="tel:0987654321"
                    className="p-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-bold rounded-xl flex items-center justify-center gap-1.5 border border-emerald-200 transition-colors text-[11px]"
                  >
